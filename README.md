...
Flask server-based single-page application that utilizes a GPT search engine to generate color palettes based on a given prompt. </br>
...
<a href="https://github.com/agiwunderlich/React_Color_App">Create Color Palette GitHub Page</a></br>
